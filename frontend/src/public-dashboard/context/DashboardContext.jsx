...
const INITIAL_ALERTS = [
    { id: "a2", type: "Warning", title: "Gate 1 - CONGESTION", message: "Surge predicted in next 15 minutes.", time: new Date(Date.now() - 300000) },
...
const USER_STATE = {
    ...
    history: [] // History cleared since other zones are gone
};
